package com.transition.demon.adapter;
...
/**
 * Created by lixinxin on 16/1/12.
 */
public class LinearAdapter extends RecyclerView.Adapter<LinearAdapter.ViewHolder> {
    ...
    public LinearAdapter(String[] apiArray, OnRecyclerItemClick onRecyclerItemClick) {
        mApiArray = apiArray;
        mOnRecyclerItemClickListener = onRecyclerItemClick;
    }

    @Override
    public LinearAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                              int viewType) {
